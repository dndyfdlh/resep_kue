...
class LapisPandanDetail extends StatefulWidget {
  const LapisPandanDetail({Key? key});

  @override
  State<LapisPandanDetail> createState() => _LapisPandanDetailState();
}

class _LapisPandanDetailState extends State<LapisPandanDetail> {
  @override
